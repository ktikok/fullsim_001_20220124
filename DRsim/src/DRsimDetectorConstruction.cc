...
: G4VUserDetectorConstruction(), fMessenger(0), fMaterials(NULL) {
  std::cout << " DRsimDetectorConstruction::DRsimDetectorConstruction(): G4VUserDetectorConstruction(), fMessenger(0), fMaterials(NULL) {\n " << std::endl;
...
DRsimDetectorConstruction::~DRsimDetectorConstruction() {
  std::cout << " DRsimDetectorConstruction::~DRsimDetectorConstruction() { \n" << std::endl;
...
void DRsimDetectorConstruction::DefineMaterials() {
  std::cout << " void DRsimDetectorConstruction::DefineMaterials() { \n" << std::endl;

  fMaterials = DRsimMaterials::GetInstance();
}

G4VPhysicalVolume* DRsimDetectorConstruction::Construct() {
  std::cout << " G4VPhysicalVolume* DRsimDetectorConstruction::Construct() {]\n " << std::endl;
...
void DRsimDetectorConstruction::Barrel(G4LogicalVolume* towerLogical[], G4LogicalVolume* PMTGLogical[], G4LogicalVolume* PMTfilterLogical[], G4LogicalVolume* PMTcellLogical[],
  ...
  std::cout << " void DRsimDetectorConstruction::Barrel(G4LogicalVolume* towerLogical[], G4LogicalVolume* PMTGLogical[], G4LogicalVolume* PMTfilterLogical[], G4LogicalVolume* PMTcellLogical[],  G4LogicalVolume* PMTcathLogical[], std::vector<G4LogicalVolume*> fiberLogical[], std::vector<G4LogicalVolume*> fiberLogical_[], std::vector<DRsimInterface::DRsimTowerProperty>& towerProps) { \n" << std::endl;
