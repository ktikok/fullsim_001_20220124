...
# do : -------------------------------------------------------------------------------------
cd /fcc/tikim/hep_fcc_dual_readout_001_2022_01_24/dual-readout/install ;source 0setenv-cc7-gcc8.sh 


# to apply change
cd /fcc/tikim/hep_fcc_dual_readout_001_2022_01_24/dual-readout/build; make -j12 install; cd ../install
